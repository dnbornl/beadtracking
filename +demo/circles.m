%DEMO.CIRCLES Demonstrate the CIRCLES function.
%   This script creates a grid of circle positions, then plots the circles
%   as a single patch using the CIRCLES function. Various combinations of 
%   color, transparency, and line properties are demonstrated.
%
%   See also CIRCLES.
